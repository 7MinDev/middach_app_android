...
package com.sevenmindev.middach.test;

import static com.sevenmindev.middach.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import com.sevenmindev.middach.core.News;
import com.sevenmindev.middach.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.sevenmindev.middach.ui.CarouselActivity}
     */
    public NewsViewTest() {
