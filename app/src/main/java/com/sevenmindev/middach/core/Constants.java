...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.sevenmindev.middach";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Middach";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.sevenmindev.middach.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.sevenmindev.middach.";
