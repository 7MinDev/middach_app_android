...
Middach is a result of a template project I've developed over the years as well as
...
Middach is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.sevenmindev.middach/com-sevenmindev-middach/pulls).
